...
DATADIR = 'Preprocessed_Data/Final_Annual_PRECIP/'
...
model = keras.models.load_model('Models/best_network_sherpa_phase_2_random6_00012.h5')

path_to_file = 'Preprocessed_Data/Final_Annual_PRECIP/full_physics_essentials_valid_month02_features.nc'
...
myds.to_netcdf('Models/Final_Sherpa_DNN_Full_Annual.nc')
